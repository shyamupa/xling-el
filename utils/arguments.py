...
PARSER.add_argument('--lang', type=str, default="en", help='comma sep')
...
PARSER.add_argument('--trcands', type=str, default=None, help='tr surface --> cand list')
PARSER.add_argument('--ttcands', type=str, default=None, help='tt surface --> cand list')
...
PARSER.add_argument('--test_doc', type=str, default=None, help='test document, containing text in a single sentence')
PARSER.add_argument('--out_doc', type=str, default=None, help='where the output json will be written')
